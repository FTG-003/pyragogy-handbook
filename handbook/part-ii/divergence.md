...
![two paths separating from a shared origin then a single re-convergence point; human path amber, agent path indigo](/diagrams/06_divergence.svg)

## Why an unlike peer is good at the moving-apart
