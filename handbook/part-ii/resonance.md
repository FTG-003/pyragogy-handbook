...
## The doubt this page refuses to bury
...
- On **emergence** (system-level properties absent in the components): overview with sources, *Wikipedia*, "Emergence." https://en.wikipedia.org/wiki/Emergence — used here for the established sense that a whole can exhibit properties its parts do not.
