...
![tool use (open chain) vs co-presence (closed loop)](/diagrams/03_the-shift.svg)
...
This is the lineage the project forks from. **[Peeragogy](https://peeragogy.org/)** — the framework Howard Rheingold and his collaborators have built and released into the public domain since 2012 — described what learning looks like when there is no teacher at the front of the room: people without a designated authority reviewing each other's work, questioning each other, producing knowledge together. Peeragogy's whole bet was that learning can be organized horizontally, among peers. Its setting was human to human. Co-presence is what happens to that bet when one of the peers is not human — when the horizontal arrangement has to make room for a participant made of weights on a server.

That participant, treated as a contributor to where the thinking goes rather than a servant of what the learner asks for, is what the next chapter calls a [cognitive peer](/en/handbook/part-ii/what-is-pyragogy). This chapter does not define that term; it only opens the door it walks through. The threshold is the move from instrument to presence. The definition — and the honest accounting of how thin and asymmetric that "peer" status really is — belongs to [What is Pyragogy](/en/handbook/part-ii/what-is-pyragogy), and the reader who wants the full argument should go there next.

## On calling this a paradigm shift

The phrase in the title is borrowed, and it should be handled with some care rather than waved like a banner. **[Thomas Kuhn](https://plato.stanford.edu/entries/thomas-kuhn/)** coined "paradigm shift" to describe how a science breaks from one framework of normal puzzle-solving into another that is, in his strong sense, *incommensurable* with it — measured by no common ruler, so that the old questions and the new ones do not even line up. That is a heavy claim, and I am not making the heavy version of it. I am not claiming that the science of learning has undergone a Kuhnian revolution, that the old framework is now false, or that the literature on pedagogy has been overturned. It has not, and to say so would be the kind of novelty inflation this handbook is trying to avoid.
...
- How is **rhythm** coordinated, when one party works in bursts of fatigue and the other does not tire? ([Cognitive Rhythm](/en/handbook/part-ii/cognitive-rhythm))
- What is **disagreement** worth, when one side will not remember the argument after the session resets, and the other knows it? ([Cognitive Friction](/en/handbook/part-ii/cognitive-friction))
- How is **responsibility** distributed across a thought that neither party produced alone? ([The Epistemic Ownership Dilemma](/en/handbook/part-vii/epistemic-ownership))
- And how does anything **stable** — a shared understanding, a durable record — get built out of an exchange that is, on the machine's side, continuously forgetting? ([Synchronization](/en/handbook/part-ii/synchronization), [Pattern: Context Persistence](/en/handbook/part-iii/context-persistence))
...
↑ Back to **[Part I — The Shift](/en/handbook/part-i)** · [Handbook](/en/handbook) · [Home](/en/home)
