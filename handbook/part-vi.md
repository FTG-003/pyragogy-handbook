...
# Part VI — Anti-Patterns and Practical Failures
...
This section documents how human–AI co-production fails. It names the recurring traps, the breakdown modes of multi-agent work, and the emergency procedures that keep the network usable when things go wrong. — *function: `document`*
