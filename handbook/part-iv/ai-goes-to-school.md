...
## What this is not — said directly, because the temptation is real
...
This is not a report of the Pyragogy framework being piloted in a classroom — no such pilot exists to report. It is not evidence that an AI cognitive peer improves learning outcomes in formal education — that claim has no study behind it here, and the [Compliance Trap](/en/handbook/part-vi/compliance-trap) and the [Epistemic Ownership Dilemma](/en/handbook/part-vii/epistemic-ownership) are exactly the reasons it would need a careful one. And it is not a claim that the education-research "pyragogy" validates ours by sharing a name — terminological convergence is a clue to chase, not a result to bank.
...
## The study that should exist, and does not
...
It would start where the classroom literature already is: a self-determined, peer-driven setting, postgraduate or adult self-formation, where the [Newcomer Protocol](/en/handbook/part-iii/newcomer-protocol) governs how a human or an agent joins the group. It would introduce the artificial participant not as a tutor and not as a search box — those are the old hierarchy in new clothes — but in the functional-peer role the framework defines, performing [Adversarial Friction](/en/handbook/part-iii/adversarial-friction) against student work the way a demanding classmate would. And it would measure the one thing the literature so far only gestures at: whether the friction produces [Cognitive Friction](/en/handbook/part-ii/cognitive-friction) that helps a learner think, or merely the appearance of rigor that a student learns to wait out.
...
- Aigerim Mynbayeva, Kamchat Yessenova, and Aigul Karabutova, "Exploring heutagogy, knowledge management, and rhizomatic learning approaches in Master's degree programs," *Scientific Herald of Uzhhorod University, Series Physics* (2024), no. 55, pp. 2919–2928. https://doi.org/10.54919/physics/55.2024.291vr9 (DOI resolves; download also at https://physics.uz.ua/en/article/download/exploring-heutagogy-knowledge-management-and-rhizomatic-learning-approaches-in-master-s-degree-programs). Confirmed source: exact phrase "transition to heutagogical foundations in postgraduate education and to pyragogy in postgraduate education" present; 149-student survey confirmed; pyragogy also appears in Table 1 body.
- Volodymyr Zinchenko, Nataliia Lazirko, Roman Manko, Oksana Huda, and Mariia Ivanyshyn, "Perspectives of using VR to increase accessibility in distance education," *Revista Eduweb* 18, no. 2 (2024): 141–151. https://doi.org/10.46502/issn.1856-7576/2024.18.02.10 (DOI resolves, HTTP 302 → article PDF). Source for the definition of pyragogy as "a new method of learning" based on "joint research, the presence of another student, active critical feedback and high responsibility," attributed to Turchyn et al. (2023).
